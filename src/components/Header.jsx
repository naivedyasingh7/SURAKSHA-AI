...
export default function Header() {
  ...
  return (
    <header className="site-header">
      ...
      >
        {/* Logo */}
        <a href="/" className="logo" id="header-logo" aria-label="Suraksha AI Home">
        ...
        {/* CTA */}
        <a href="#contact" className="btn-primary" id="header-cta" aria-label="Get started with Suraksha AI">
          Get Started
